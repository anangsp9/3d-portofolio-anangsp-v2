...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className="w-full sm:w-[250px] mx-auto">
    <motion.div
      variants={fadeIn("right", "spring", index * 0.5, 0.75)}
      className="custom-card updated-size"
    >
      <div className="custom-card-bg"></div>
      <div className="custom-card-blob"></div>
      <div className="custom-card-content">
        <img
          src={icon}
          alt={title}
          className="w-16 h-16 object-contain mb-4 z-10"
        />
