  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Konten mengisi sisa tinggi, tapi spacing antar elemen tetap natural */}
...
const Works = () => {
  return (
    <>
      ...
      {/* Grid dengan items-stretch agar semua child punya tinggi sama per baris */}
      <div className="mt-20 grid gap-7 sm:grid-cols-2 lg:grid-cols-3 items-stretch">
      ...
      {/* Tombol View All (Animated) */}
      {/* Tombol View All (styled + animated seperti contohmu) */}
      <motion.div
      ...
      >
        <button
          ...
          className="px-10 py-3 bg-gradient-to-r from-purple-800 to-indigo-900 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-purple-900 shadow-purple-900 uppercase font-serif tracking-widest relative overflow-hidden group text-transparent cursor-pointer z-10 after:absolute after:rounded-full after:bg-purple-200 after:h-[85%] after:w-[95%] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 hover:saturate-[1.15] active:saturate-[1.4]"
        >
          Button
          <p className="absolute z-40 font-bold bg-gradient-to-r from-purple-800 to-indigo-900 bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-full h-full w-full transition-all duration-300 -translate-y-[30%] tracking-widest">
            See All
          </p>
          <p className="absolute z-40 top-1/2 left-1/2 bg-gradient-to-r from-purple-900 to-indigo-950 bg-clip-text text-transparent -translate-x-1/2 translate-y-full h-full w-full transition-all duration-300 group-hover:-translate-y-[40%] tracking-widest font-extrabold">
            Projects
          </p>
          {/* wave utama */}
          <svg
          ...
          >
            <defs>
              <linearGradient
                ...
                x1="50%"
              >
                <stop offset="0%" stopOpacity={1} stopColor="#4B0082" />
                <stop offset="100%" stopOpacity={1} stopColor="#2E0854" />
              </linearGradient>
            </defs>
            <g
          ...
          {/* wave kedua */}
          <svg
            className="absolute w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-[30%] group-hover:-translate-y-[33%] group-hover:scale-95 transition-all duration-500 z-40 fill-purple-800"
